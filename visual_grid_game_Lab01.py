...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        """
        Return the information currently sensed by the agent.
        """
        return {
    ...
    def run_loop(self):
        ...
        def step():
            if not self.env.is_done():
                ...
                print(
                    f"Action: {action} | "
                    f"Position: {percept['agent_pos']} | "
                    f"Smells toxin: "
                    f"{percept['smells_toxin']} | "
                    f"Food left: "
                    f"{percept['remaining_food']} | "
